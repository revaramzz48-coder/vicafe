    ...
    <div class="row justify-content-center">
        <div class="col-lg-8" style="animation: fadeInUp 1s ease;">
            ...
            <div class="glass-container p-5 text-center">
                <i class="fa-solid fa-quote-left fs-1 text-warning mb-4 opacity-50"></i>
                ...
                <div class="mt-4 pt-4 border-top border-secondary opacity-75">
                    <span class="badge bg-dark border border-warning text-warning px-3 py-2 rounded-pill mx-1">Aesthetic</span>
                    <span class="badge bg-dark border border-warning text-warning px-3 py-2 rounded-pill mx-1">Cozy</span>
                    <span class="badge bg-dark border border-warning text-warning px-3 py-2 rounded-pill mx-1">Premium Coffee</span>
                </div>
            </div>
...
.text-light-50 {
    color: rgba(245, 243, 244, 0.8) !important;
}
