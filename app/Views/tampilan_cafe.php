...
<head>
    ...
    <style>
        ...
        .card-menu { border: none; border-radius: 15px; transition: all 0.3s ease; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
...
<nav class="navbar navbar-expand-1g navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand fw-bold" href="#">☕ViCafe☕</a>
    </div>
        ...
        <?php foreach ($semua_menu as $m) : ?>
            <div class="col-md-4 mb-4">
                <div class="card card-menu h-100">
                    <img src="https://source.unsplash.com/400x300/?coffee" class="card-img-top">
                    <div class="card-body">
                        ...
                        <button class="btn btn-warning w-100 fw-bold">Pesan</button>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
