        ...
        <div class="col-md-6 col-lg-5" style="animation: fadeInUp 0.8s ease;">
            ...
            <div class="glass-container p-5">
                <div class="text-center mb-4">
                    <i class="fa-solid fa-user-circle fs-1 mb-3" style="color: var(--accent-gold);"></i>
                    <h3 class="fw-bold">Welcome Back</h3>
                    <p class="text-muted">Login untuk melanjutkan pesanan Anda.</p>
                </div>
                ...
                <form action="<?= base_url('cek_login_pelanggan') ?>" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password" class="form-control border-start-0 bg-white" placeholder="Masukkan password" required>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="text-muted small mb-0">Belum punya akun? <a href="<?= base_url('register') ?>" class="text-decoration-none fw-bold" style="color: var(--accent-gold);">Daftar sekarang</a></p>
                    </div>
