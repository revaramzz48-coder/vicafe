...
$routes->get('login_pelanggan', 'Home::login_pelanggan');
$routes->post('cek_login_pelanggan', 'Home::cek_login_pelanggan');
$routes->get('register', 'Home::register');
$routes->post('simpan_register', 'Home::simpan_register');
$routes->get('logout_pelanggan', 'Home::logout_pelanggan');
